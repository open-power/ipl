...
static struct ipl_step ipl2[] = {
	...
	{ IPL_DEF(proc_sbe_tp_chiplet_reset),     2,  3,  true,  true  },
	{ IPL_DEF(proc_sbe_tp_gptr_time_initf),   2,  4,  true,  true  },
	{ IPL_DEF(proc_sbe_dft_probe_setup_1),    2,  5,  true,  true  },
	{ IPL_DEF(proc_sbe_npll_initf),           2,  6,  true,  true  },
	{ IPL_DEF(proc_sbe_rcs_setup),            2,  7,  true,  true  },
	{ IPL_DEF(proc_sbe_tp_switch_gears),      2,  8,  true,  true  },
	{ IPL_DEF(proc_sbe_npll_setup),           2,  9,  true,  true  },
	{ IPL_DEF(proc_sbe_tp_repr_initf),        2, 10,  true,  true  },
	{ IPL_DEF(proc_sbe_setup_tp_abist),       2, 11,  true,  true  },
	{ IPL_DEF(proc_sbe_tp_arrayinit),         2, 12,  true,  true  },
	{ IPL_DEF(proc_sbe_tp_initf),             2, 13,  true,  true  },
	{ IPL_DEF(proc_sbe_dft_probe_setup_2),    2, 14,  true,  true  },
	{ IPL_DEF(proc_sbe_tp_chiplet_init),      2, 15,  true,  true  },
