...
static int ipl_proc_sbe_attr_setup(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 2);
...
static int ipl_proc_sbe_tp_chiplet_init1(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 3);
...
static int ipl_proc_sbe_tp_gptr_time_initf(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 4);
...
static int ipl_proc_sbe_dft_probe_setup_1(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 5);
...
static int ipl_proc_sbe_npll_initf(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 6);
...
static int ipl_proc_sbe_npll_setup(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 7);
...
static int ipl_proc_sbe_tp_switch_gears(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 8);
...
static int ipl_proc_sbe_clock_test(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 9);
...
static int ipl_proc_sbe_tp_chiplet_reset(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 10);
...
static int ipl_proc_sbe_tp_repr_initf(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 11);
...
static int ipl_proc_sbe_tp_chiplet_init2(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 12);
...
static int ipl_proc_sbe_setup_tp_abist(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 13);
...
static int ipl_proc_sbe_tp_arrayinit(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 14);
...
static int ipl_proc_sbe_tp_initf(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 15);
...
static int ipl_proc_sbe_dft_probe_setup_2(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 16);
...
static int ipl_proc_sbe_tp_chiplet_init3(void)
{
	...
	pdbg_for_each_class_target("pib", pib) rc |= sbe_istep(pib, 2, 17);
